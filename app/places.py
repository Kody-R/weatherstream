...
class PlaceManager:
    ...
    def __init__(self, config_store) -> None:
        ...
        self._client = httpx.Client(timeout=httpx.Timeout(45.0, connect=10.0), follow_redirects=True, headers={"User-Agent": "WeatherStream/0.2.5.1"}, limits=httpx.Limits(max_connections=4, max_keepalive_connections=2))
